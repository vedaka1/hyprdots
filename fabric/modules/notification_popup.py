...
class ActionButton(Button):
    def __init__(self, action: NotificationAction, index: int, total: int, notification_box):
        ...
        style_class = 'start-action' if index == 0 else 'end-action' if index == total - 1 else 'middle-action'
    ...
    def create_header(self, notification):
        ...
        return CenterBox(
            ...
            start_children=[
                Box(
                    spacing=4,
                    children=[app_icon, Label(notification.app_name, name='notification-app-name', h_align='start')],
                )
            ],
            ...
            children=[
                Box(
                    ...
                    children=CustomImage(
                        pixbuf=notification.image_pixbuf.scale_simple(48, 48, GdkPixbuf.InterpType.BILINEAR)
