...
from modules.audio import AudioSwitcher
...
class Buttons(Box):
    def __init__(self, **kwargs):
        ...
        # self.caffeine_button = AudioButton()
        self.audio_switcher = AudioSwitcher(name='caffeine-button')
