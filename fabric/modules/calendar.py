...
class Calendar(Gtk.Box):
    def __init__(self):
        ...
        self.prev_month_button = Gtk.Button(
            name='prev-month-button', child=Label(name='month-button-label', markup=icons.chevron_left)
        )
        ...
        self.next_month_button = Gtk.Button(
            name='next-month-button', child=Label(name='month-button-label', markup=icons.chevron_right)
        )
